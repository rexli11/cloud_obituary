...
urlpatterns = [
    ...
    path('update_obituary/', views.update_obituary, name='update_obituary'),
    path('obituary/drafts/', views.draft_obituaries, name='draft_obituaries'),
    path('obituary/draft/edit/<int:obituary_id>/', views.edit_draft, name='edit_draft'),
    path('obituary/list/', views.obituary_list, name='obituary_list'),
    path('obituary/draft/preview/<int:obituary_id>/', views.preview_draft, name='preview_draft'),
    path('obituary/retrieve/<int:obituary_id>/', views.retrieve_obituary, name='retrieve_obituary'),
    path('obituary/make/<int:obituary_id>/', views.make_obituary, name='make_obituary'),
